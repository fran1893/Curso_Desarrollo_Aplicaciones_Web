...
--
-- Servidor: 127.0.0.1
-- Temps de generació: 13-10-2022 a les 14:02:35
...
--
-- Estructura de la taula `alumno_asignatura_curso`
--
...
--
-- Bolcament de dades per a la taula `alumno_asignatura_curso`
--
...
(14, '82937751G', 'Manolo', 'Hamill', 'Bilbao', '1977-01-02', 'H', 0),
(15, '80502866Z', 'Alejandro', 'Kohler', 'Barcelona', '1980-03-14', 'H', 0),
...
--
-- Índexs per a la taula `alumno_asignatura_curso`
--
...
--
ALTER TABLE `alumnos`
  MODIFY `id_alumno` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=627;

--
-- AUTO_INCREMENT per la taula `alumno_asignatura_curso`
--
ALTER TABLE `alumno_asignatura_curso`
  MODIFY `id_matricula` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT per la taula `profesores`
--
ALTER TABLE `profesores`
  MODIFY `id_profesor` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- Restriccions per a la taula `alumno_asignatura_curso`
--
ALTER TABLE `alumno_asignatura_curso`
